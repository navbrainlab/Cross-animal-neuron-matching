...
`baselines/official/adapters/gwot_md/prepare_atanas21_paper_inputs.py`：它组合
...
```bash
baselines/official/adapters/gwot_md/run_atanas21_paper_reproduction.sh official-h0-audit
```

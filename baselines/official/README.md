...
`/home/ubuntu/klb/nuclr/nuclr/baselines/official/`
...
python baselines/official/scripts/audit_official_repos.py
```

The setup script records the exact git commit of every cloned repository in:

`baselines/official/manifests/official_repo_revisions.tsv`

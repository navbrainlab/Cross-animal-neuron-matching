...
- Pinned official source under `baselines/official/third_party/nuclr_official`.
...
```bash
python baselines/official/adapters/nuclr_official_scratch50k/audit_plan.py
```

Engineering smoke (200 updates; never use as a paper result):

```bash
bash baselines/official/adapters/nuclr_official_scratch50k/smoke.sh
```

Full 2 datasets x 5 folds x 3 seeds:

```bash
bash baselines/official/adapters/nuclr_official_scratch50k/run_cv5x3.sh
```

...
STAT_REPO = Path(
    ...
    "baselines/official/third_party/wormid_official/stat-atlas"
)
...
sys.path.insert(
    0,
    str(ROOT / "results/supplementary/model_development_cv5x3/code"),
)

# OFFICIAL GITHUB CODE
from models import Atlas
import utils as stat_utils
from baselines.official.adapters.stat_atlas.evaluate_statatlas_official import (

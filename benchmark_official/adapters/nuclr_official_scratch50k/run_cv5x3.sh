...
SCRIPT="benchmark_official/adapters/nuclr_official_scratch50k/run_one.py"
AUDIT="benchmark_official/adapters/nuclr_official_scratch50k/audit_plan.py"
SUMMARY="benchmark_official/adapters/nuclr_official_scratch50k/summarize.py"
LOGDIR="benchmark_official/logs/nuclr_official_scratch50k_cv5x3"
RUNROOT="benchmark_official/runs/nuclr_official_scratch50k_cv5x3"
mkdir -p "$LOGDIR"

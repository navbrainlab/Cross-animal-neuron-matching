...
bash benchmark_official/adapters/stat_atlas/run_statatlas_official_cv5.sh
```

Outputs:
- `benchmark_official/runs/stat_atlas_official/query_level.csv`
- `benchmark_official/runs/stat_atlas_official/fold_metrics.csv`
- `benchmark_official/runs/stat_atlas_official/summary.csv`

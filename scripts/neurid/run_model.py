#!/usr/bin/env python3
"""One-command training and evaluation for NeuRID."""
...
def evaluate(fold: int, data: Path, output: Path, args: argparse.Namespace) -> None:
    run([sys.executable, "-m", "scripts.neurid.evaluate_mprt_static_atlas",
...
def main() -> None:
    ...
    if len(folds) == 5:
        run([sys.executable, "-m", "scripts.neurid.summarize_cv5_seed42",

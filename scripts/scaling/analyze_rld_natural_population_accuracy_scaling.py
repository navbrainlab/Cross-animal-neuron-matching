...
DEFAULT_OUT = ROOT / "runs/rld_natural_accuracy_scaling_v1"

METHODS = {
    "MPRT": ROOT / "runs/unified_benchmark/ours_static/rld",
    "fDNC": ROOT / "runs/unified_benchmark/fdnc/rld",
}
...
def main():
    ...
    protocol = {
        "protocol": "RLD natural population-size accuracy scaling v1",
